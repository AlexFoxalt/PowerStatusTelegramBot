TMP_BOT_INFO = (
    ...
    "информацию о наличии электроэнергии в ЖК и сопутствующую информацию. Ну и, конечно же, "
    ...
    "❓<b>Зачем боту информация обо мне?</b>\n"
    ...
    "❓<b>На какие ЖК распространяется работа бота?</b>\n"
