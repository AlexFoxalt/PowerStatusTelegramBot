TMP_BOT_INFO = (
    ...
    "Для меня очень важно, чтобы вашего интернета хватало для таких операций. "
    "Если вы сталкиваетесь с проблемой, что я вам не отвечаю, или отвечаю по несколько раз,"
    " то скорее всего, проблема в вашем интернет соединении. Если же проблема остаётся при "
