TMP_BOT_INFO = (
    ...
    "Для меня очень важно, чтобы вашего соединения хватало для таких операций. "
    "Если вы сталкиваетесь с ситуацией, что я вам не отвечаю, или отвечаю по несколько раз,"
    " то скорее всего, причина в вашем слабом интернете. Если же ситуация повторяется при "
...
TMP_DTEK_INFO = (
    "Актуальный график 🎲\n\n"
    '<i>Источник: <a href="https://www.dtek-oem.com.ua/ua/shutdowns"><b>Сайт ДТЭК</b></a></i>'
)
TMP_LIGHT_ON = (
    "💡 На текущий момент 💡\n\n"
